...
param_basicos  <- list( "cp"=           -0.92665,  #complejidad minima
                        "minsplit"=   1950,     #minima cantidad de registros en un nodo para hacer el split
                        "minbucket"=   974,     #minima cantidad de registros en una hoja
