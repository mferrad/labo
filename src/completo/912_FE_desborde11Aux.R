...
require("stringr")
dataset2  <- data.frame(fread("~/buckets/b1/exp/FE8120MartinFullSinLags/paquete_premium_ext.csv.gz", stringsAsFactors= TRUE))

#### Me creo un data frame con los valores que quiero analizar ########

variablesTarget=(read.table("~/buckets/b1/datasets/top10Cor2.txt"))
