...
hs <- makeParamSet( 
         makeNumericParam("eta",              lower=  0.01 , upper=    0.5),   #equivalente a learning rate
         makeNumericParam("colsample_bytree", lower=  0.2  , upper=    1.0),   #equivalente a feature_fraction
         makeIntegerParam("min_child_weight", lower=  0L   , upper=   8000L),    #groseramente equivalente a  min_data_in_leaf
