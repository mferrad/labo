...
entrega  <- as.data.table( list( "numero_de_cliente"= dapply$numero_de_cliente,"Predicted"= as.integer(  prediccion >  1/60  ) ) )

#entrega  <- as.data.table( list( "numero_de_cliente"= dapply$numero_de_cliente,"prob"= prediccion ) )
