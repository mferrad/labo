...
ksemilla  <- 200443  #poner aqui la PRIMERA de sus cinco semillas
...
dataset  <- fread("C:\\Users\\Martin\\Desktop\\MineriaDeDatos\\labo\\exp\\FE4020\\paquete_premium_202011_ext.csv", stringsAsFactors= TRUE)
...
dapply  <- fread("C:\\Users\\Martin\\Desktop\\MineriaDeDatos\\labo\\exp\\FE4020\\paquete_premium_202101_ext.csv")
